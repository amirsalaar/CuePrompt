...
- Requires **microphone** and **speech recognition** permissions (entitlements generated by `scripts/build.sh`)
...
make build-notarize  # Release + notarize for distribution
